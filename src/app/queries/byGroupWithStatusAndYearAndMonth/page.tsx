...
import { listAllSchedulesByGroupWithStatusAndYearAndMonth } from '@/app/api'
...
const ByGroupWithStatusAndYearAndMonth: FC = () => {
  ...
  const listAllSchedulesByGroupWithStatusAndYearAndMonthQuery = useQuery({
    queryKey: ['schdules', 'byGroupWithStatusAndYearAndMonth', listSchedulesVariables],
...
export default ByGroupWithStatusAndYearAndMonth
